...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // In production, you would validate against a real authentication service
  ...
  const handleDemoLogin = (userType: "admin" | "user") => {
    ...
    const user =
      userType === "admin"
        ? demoUsers.find((u) => u.role === "administrator") || demoUsers[0]
        : demoUsers.find((u) => u.role === "user") || demoUsers[1]
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-xl border-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription>Sign in to your account to continue building your business plans</CardDescription>
          </CardHeader>
