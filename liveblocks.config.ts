...
// One-line re-export of the four Liveblocks symbols the codebase expects.
// You can later replace this with a full `createRoomContext` setup if you
// need typed presence / storage, but for now this unblocks the build.
export { RoomProvider, useRoom, useStorage, useMutation } from "@liveblocks/react"
