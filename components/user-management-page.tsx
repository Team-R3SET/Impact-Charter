...
export function UserManagementPage() {
  ...
  const [newUser, setNewUser] = useState({
    name: "",
    email: "",
    role: "regular" as "administrator" | "regular",
    company: "",
    department: "",
    isActive: true,
  })
  ...
  const handleExportUsers = () => {
    const csvContent = [
      ["Name", "Email", "Role", "Company", "Department", "Status", "Created Date"].join(","),
  ...
  return (
    <div className="space-y-6">
                ...
                <DialogContent>
                  ...
                  <div className="grid gap-4 py-4">
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                      ...
                      <Select
                        value={newUser.role}
                        onValueChange={(value: "administrator" | "regular") => setNewUser({ ...newUser, role: value })}
                      >
      ...
      {/* Delete User Dialog */}
      <AlertDialog open={!!deletingUserId} onOpenChange={(isOpen) => !isOpen && setDeletingUserId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              onClick={() => {
                if (deletingUserId) {
                  // Force the dialog state to update synchronously before proceeding
                  flushSync(() => {
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Select
                  ...
                  onValueChange={(value: "administrator" | "regular") =>
